 ...
 private boolean check()
    {
        String text1 = t1.getText();
             ...
             if(text1.equals(""))
        {
            JOptionPane.showMessageDialog(rootPane, "Enter Patient ID");
            t1.requestFocus();
            return false;
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        PreparedStatement ps1,ps2,ps3,ps4,ps5,ps6;
         String text1 = t1.getText();
             ...
             String query1 = "DELETE FROM personal where id=?";
             String query2 = "DELETE FROM complaints where id=?";
             String query3 = "DELETE FROM history where id=?";
             String query4 = "DELETE FROM gexam where id=?";
             String query5 = "DELETE FROM sexam where id=?";
             String query6 = "DELETE FROM analysis where id=?";
            try{
           ...
           ps3.setString(1, text1);
           ps4.setString(1, text1);
           ps5.setString(1, text1);
           ps6.setString(1, text1);
